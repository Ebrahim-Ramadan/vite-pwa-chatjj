  ...
  return (
    <div className="w-64 bg-neutral-800 border-r border-neutral-700">
     ...
     <div className="flex items-center gap-3">
          ...
          <a href="/" className="flex items-center justify-end p-2 text-neutral-900 rounded-lg text-white group text-end hover:bg-neutral-100 dark:hover:bg-neutral-700">
